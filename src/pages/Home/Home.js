    ...
    const PData = homeDoc && {
        ...
        faqSection: {
            ...
            faqsList: [
                ...
                {
                    title: (
                        <>{homeDoc.data.q6[0].text}</>
                    ),
                    description: (
                        <>
                            {homeDoc.data.a6[0].text}
                        </>
                    ),
                    key: 5,
                },
        ...
        <div className="home" id="home">
            <RenderItems>
                {PData && <>
                    ...
                    <StakingSection PData={PData.stakingSection} connectBtn={PData.connectBtn}/>
